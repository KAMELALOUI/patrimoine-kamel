package com.kamel1.mappingservice.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.kamel1.mappingservice.dto.AuthCheckResponseObject;
import com.kamel1.mappingservice.dto.JsonResponse;
import com.kamel1.mappingservice.model.HeritageSite;
import com.kamel1.mappingservice.repository.HeritageSiteRepository;
import com.kamel1.mappingservice.service.CheckAuth;
        ...
        if (result.isSuccess()) {
            ...
            if (file.isEmpty()) {
                ...
                try {
                    ...
                    heritageSite.setImageURL("http://51.21.219.120:8087/uploads/" + file.getOriginalFilename());
